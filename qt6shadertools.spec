...
Version  : 6.7.1
Release  : 13
URL      : https://download.qt.io/official_releases/qt/6.7/6.7.1/submodules/qtshadertools-everywhere-src-6.7.1.zip
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.1/submodules/qtshadertools-everywhere-src-6.7.1.zip
...
%prep
%setup -q -n qtshadertools-everywhere-src-6.7.1
cd %{_builddir}/qtshadertools-everywhere-src-6.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716940188
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtShaderTools/6.7.1/QtShaderTools/private/qshaderrewriter_p.h
/usr/include/QtShaderTools/6.7.1/QtShaderTools/private/qspirvcompiler_p.h
/usr/include/QtShaderTools/6.7.1/QtShaderTools/private/qspirvshader_p.h
/usr/include/QtShaderTools/6.7.1/QtShaderTools/private/qspirvshaderremap_p.h
/usr/include/QtShaderTools/6.7.1/QtShaderTools/private/qtshadertoolsexports_p.h
/usr/include/QtShaderTools/6.7.1/QtShaderTools/private/qtshadertoolsglobal_p.h
/usr/include/QtShaderTools/6.7.1/QtShaderTools/rhi/qshaderbaker.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6ShaderTools.so.6.7.1
/V3/usr/lib64/qt6/bin/qsb
/usr/lib64/libQt6ShaderTools.so.6
/usr/lib64/libQt6ShaderTools.so.6.7.1
