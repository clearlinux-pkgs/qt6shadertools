...
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qtshadertools-everywhere-src-6.8.0.zip
...
%prep
%setup -q -n qtshadertools-everywhere-src-6.8.0
cd %{_builddir}/qtshadertools-everywhere-src-6.8.0
pushd ..
cp -a qtshadertools-everywhere-src-6.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732572320
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtShaderTools/6.8.0/QtShaderTools/private/qshaderrewriter_p.h
/usr/include/QtShaderTools/6.8.0/QtShaderTools/private/qspirvcompiler_p.h
/usr/include/QtShaderTools/6.8.0/QtShaderTools/private/qspirvshader_p.h
/usr/include/QtShaderTools/6.8.0/QtShaderTools/private/qspirvshaderremap_p.h
/usr/include/QtShaderTools/6.8.0/QtShaderTools/private/qtshadertoolsglobal_p.h
/usr/include/QtShaderTools/6.8.0/QtShaderTools/rhi/qshaderbaker.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6ShaderTools.so.6.8.0
/V3/usr/lib64/qt6/bin/qsb
/usr/lib64/libQt6ShaderTools.so.6
/usr/lib64/libQt6ShaderTools.so.6.8.0
